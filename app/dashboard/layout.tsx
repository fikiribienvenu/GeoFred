...
import { LayoutDashboard, ClipboardList, MessageSquare, User, Home, LogOut } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-black text-sm hidden sm:block">GeoFredE-Terra</span>
            </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="sm" onClick={logout} className="gap-1.5 text-muted-foreground">
              <LogOut className="h-3.5 w-3.5" /><span className="hidden md:block">Logout</span>
            </Button>
          </div>
        </div>
      </header>
