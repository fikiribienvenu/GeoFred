...
export default function PropertyDetailPage() {
  ...
  const handleInquiry = async (e: React.FormEvent) => {
    ...
    setSending(true);
    try {
      const { data } = await axios.post(`/api/properties/${id}/inquiry`, inquiryForm);
      setInquiryResult({ success: true, message: data.message, agentPhone: data.agentPhone, accountCreated: data.accountCreated });
    } catch (err: unknown) {
      const msg = (err as { response?: { data?: { error?: string } } })?.response?.data?.error || 'Failed to send inquiry';
  ...
  return (
    <div className="min-h-screen pt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="relative h-80 md:h-[450px] rounded-2xl overflow-hidden mb-3">
              ...
              <div className="absolute top-4 right-4 flex gap-2">
                ...
                <button onClick={() => navigator.share?.({ title: property.title, url: typeof window !== 'undefined' ? window.location.href : '' })}
                  className="w-9 h-9 bg-white/90 dark:bg-gray-800/90 rounded-full flex items-center justify-center shadow hover:scale-110 transition-transform">
          ...
          <div>
            <div className="sticky top-24 space-y-4">
                ...
                <Card className="shadow-md border-primary/20">
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-12 h-12 terra-gradient rounded-full flex items-center justify-center text-white font-black text-xl flex-shrink-0">
              ...
              {/* Send Inquiry — works without account */}
      ...
      {/* Inquiry Modal — works without account */}
      <AnimatePresence>
        {showInquiry && (
          <motion.div
            initial={{ opacity: 0 }}
            ...
            <motion.div
              ...
              <div className="p-6">
                ...
                {inquiryResult ? (
                  <div className={`text-center py-6 ${inquiryResult.success ? '' : ''}`}>
                      ...
                      <label className="flex items-start gap-3 cursor-pointer">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground mt-0.5">
                            Track your inquiries, save properties, and chat with agents
                          </p>
                        </div>
                      </label>
