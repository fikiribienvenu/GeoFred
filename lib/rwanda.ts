// Rwanda Administrative Hierarchy Data
export const rwandaData = {
  ...
  "Northern Province": {
    ...
    "Gicumbi": ["Bukure", "Bwisige", "Byumba", "Cyumba", "Giti", "Kaniga", "Manyagiro", "Miyove", "Mukarange", "Mulo", "Mutete", "Nyamiyaga", "Nyankenke", "Rubaya", "Rukomo", "Rushaki", "Rutare", "Ruvune", "Rwamiko", "Shangasha"],
    "Musanze": ["Busogo", "Cyuve", "Gataraga", "Kimonyi", "Kinigi", "Muhoza", "Mushishiro", "Nkotsi", "Nyange", "Remera", "Rwaza", "Shingiro"],
  ...
  "Southern Province": {
    "Gisagara": ["Gikonko", "Gishubi", "Kansi", "Kibirizi", "Kigembe", "Mamba", "Muganza", "Mugombwa", "Mukingo", "Muyira", "Ndora", "Nyanza", "Save"],
    ...
    "Muhanga": ["Cyeza", "Kabacuzi", "Kibangu", "Kiyumba", "Muhanga", "Mushishiro", "Nyabinoni", "Nyamabuye", "Nyarubaka", "Rongi", "Rugendabari"],
  ...
  "Eastern Province": {
    ...
    "Nyagatare": ["Gatunda", "Karama", "Karangazi", "Katabagemu", "Katresi", "Kibali", "Kiyombe", "Matimba", "Mimuri", "Mukama", "Musheli", "Nyagatare", "Rukomo", "Rwempasha", "Rwimiyaga", "Tabagwe"],
  ...
  "Western Province": {
    ...
    "Nyabihu": ["Bigogwe", "Jomba", "Kabatwa", "Karago", "Kintobo", "Mukamira", "Muringa", "Rambura", "Rugera", "Rurembo", "Shyira"],
    ...
    "Rusizi": ["Bugarama", "Butare", "Bweyeye", "Gashonga", "Giheke", "Gihundwe", "Gikundamvura", "Gitambi", "Kamembe", "Muganza", "Mururu", "Nkanka", "Nkungu", "Nyakarenzo", "Nzahaha", "Rwimbogo"],
    "Rutsiro": ["Boneza", "Gihango", "Kigeyo", "Kivumu", "Manihira", "Mukura", "Murunda", "Musasa", "Mushonyi", "Mushubati", "Nyabirasi", "Ruhango", "Rusebeya"]
  }
} as const;

export type Province = keyof typeof rwandaData;
export type DistrictMap = typeof rwandaData;

export function getProvinces(): Province[] {
  return Object.keys(rwandaData) as Province[];
}

export function getDistricts(province: Province): string[] {
  return Object.keys(rwandaData[province] || {});
}

export function getSectors(province: Province, district: string): string[] {
  const districts = rwandaData[province] as Record<string, readonly string[]>;
